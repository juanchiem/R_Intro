...
kable(text_tab1) %>% kable_styling(full_width = F)
```
...
kable(text_tab2) %>% kable_styling(full_width = F)
```
...
kable(text_tab3) %>% kable_styling(full_width = F)
```
...
kable(text_tab4) %>% kable_styling(full_width = F)
```
