...
- Via archivo comprimido .zip/.tar.gz: `install.packages("C:/caminho/pacote.zip", repos = NULL)`
...
|    cos(x)   | Coseno                                |  
|    tan(x)   | Tangente                              |  
|  round(x,n) | Arredonda a $n$ dígitos                |  
|  cumsum(x)  | Calcula as somas acumuladas          |  
|             | ($x_1, x_1 + x_2, + x_1 +\ldots+x_n$) |  

- Shortcuts

|   Teclas    |           Descrição                    
|:-----------:|:---------------------------------------:
| Alt Shift K | panel do todos os atalhos
| Ctrl Z / Ctrl Shift Z |Undo/Redo 
| Alt  -      | <-
| Ctrl  r     | roda a linha completa onde esteja o cursor 
| Ctrl  l     | limpa a consola
| Ctrl Shift c| Silencia a linha 
| Ctrl  i     | organiza hierarquicamente as o bloco de codigo 
