...
Usaremos la función "map()" que es una funcion del paquete purrr, que aplica una misma accion recursivamente a una lista de objetos que le asignemos.

Ej 1 - crear un dataframe a partir de multiples archivos (primeras hojas)
...
Ej 2 - crear un dataframe a partir de multiples hojas dentro de uno o varios archivos. (Usaremos algunas técnicas de programación un poco más avanzadas que anida un bucle dentro de otro)
