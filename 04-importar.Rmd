...
Desde el menu de contenidos de esta página (izquierda - abajo), entrar a "datasets" y bajar los archivos excel a importar:
...
> Importar soja_mancha.xlsx, nombrándolo "soja"
> Importar can_phoma.xlsx, nombrándolo "canola"

Importemos los datos "crudos" (planillas de campo). Via clicks y pegamos los codigos auto-generados en nuestro script 
...
Muchas veces en una misma sesión se generan nuevos datasets a partir de uno importado. Al reiniciar una sesión deberían tenerse rpidamente disponibles todos los objetos creados en días previos, los que pueden recopilarse en un archivo de múltiples objetos ".RData" e importarse directamente desde éste.
