...
Veamos de qué se tratan ambos formatos.
...
Luego de haber chequeado los tipos de datos con `str()` agregamos al archivo "datos_curso.RData" los nuevos archivos "_long", así quedan disponibles rápidamente para las siguientes etapas
...
Muchas variables biológicas no cumplen con los supuestos de las pruebas estadísticas  paramétricas: no se distribuyen normalmente. Dos transformaciones son mayormente sugeridas para los porcentajes: 

* Transformación Arcsine o logit
