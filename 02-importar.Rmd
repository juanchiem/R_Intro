...
Un primer paso en nuestras investigaciones (fundacional, determinante del resto de flujo de trabajo) es la toma de datos. Nos debemos a los datos. Es nuestra razón de ser como investigadores. 

Un buen diseño experimental, con correcta toma de datos de calidad, no garantizan, pero si aumentan significativamente las probabilidades que nuestro trabajo goze de buen porvenir. 
