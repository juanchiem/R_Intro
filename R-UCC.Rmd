...
Ejemplo de [@parra2007tendencias]
![](fig/PesoVacas.gif)
...
Generalmente, el nombre de las funciones es intuitivo, por ejemplo, `mean` es la función que calcula la media, `round` es la funión que redondea un número.
